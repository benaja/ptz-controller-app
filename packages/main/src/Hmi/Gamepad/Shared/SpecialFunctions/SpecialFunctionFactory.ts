...
export class SpecialFunctionFactory {
  ...
  private static buildMacroLoopSpecialFunction(
    ...
    const configValidator = new ConfigValidator();
    const validConfig = configValidator.validate<ISpecialFunctionMacroLoopConfig>(
      config,
      MacroLoopSchema
    );
  ...
  private static buildMacroToggleSpecialFunction(
    ...
    const configValidator = new ConfigValidator();
    const validConfig = configValidator.validate<ISpecialFunctionMacroToggleConfig>(
      config,
      MacroToggleSchema
    );
