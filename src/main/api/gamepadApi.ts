import { emit } from '@main/events/eventBus';
import { defaultSecondaryKeyBindings, defualtPrimaryKeyBindings } from '@main/gamepad/KeyBindings';
import { userConfigStore } from '@main/store/userStore';
