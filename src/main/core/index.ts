import { setupApi } from '@main/api/setupApi';
import { setupGamepads } from '@main/gamepad/setupGamepads';
import {
  setupCameraConnectionHandler,
  useCameraConnectionHandler,
} from './CameraConnection/CameraConnectionHandler';
import { GamepadApi } from '@main/api/gamepadApi';
import { CameraApi } from '@main/api/cameraApi';
import { ObsMixer } from '@main/VideoMixer/Obs/ObsMixer';
import { VideoMixerApi } from '@main/api/videoMixerApi';
import { setupVideoMixHandler } from '@main/VideoMixer/VideoMixHanlder';
