import { AxisEventPayload, ButtonEventPayload, Gamepad } from '@main/api/gamepadApi';
import { CgfPtzCameraState } from '@main/core/CameraConnection/CgfPtzCamera/CgfPtzCameraState';
import { clients } from '@main/websocket';
